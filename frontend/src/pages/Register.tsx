            ...
            <form onSubmit={handleRegister} className="space-y-8 md:space-y-10">
              ...
              <div className="pt-2 space-y-4">
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-[8px] uppercase tracking-[0.3em] font-bold text-slate-600"><span className="bg-[#0f172a] px-4">Social Encryption</span></div>
                </div>
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full py-4 bg-white/5 border border-white/10 text-white rounded-2xl font-bold uppercase tracking-widest text-[10px] hover:bg-white/10 active:scale-[0.98] transition-all flex items-center justify-center gap-3"
                >
